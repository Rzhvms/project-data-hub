namespace Domain.Entities.Project.Categories.Constants;

/// <summary>
/// Константы с названием категорий по умолчанию.
/// </summary>
public static class DefaultCategoryNames
{
    ...
    public const string ProjectDocumentation = "Проектная документация";
    public const string WorkingDocumentation = "Рабочая документация";
    public const string DigitalTechnologies = "Цифровые технологии";
}